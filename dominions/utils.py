...
class DominionsVersion( object ):
    ...
    def from_program_image( cls, program_image ):
        ...
        elif "version 4.05" == from_string( program_image, 0x211205, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.05"
        elif "version 4.05b" == from_string( program_image, 0x3769ac, 13 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.05b"
        elif "version 4.07" == from_string( program_image, 0x22b328, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.07"
        elif "version 4.10" == from_string( program_image, 0x240a1b, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.10"
        elif "version 4.14" == from_string( program_image, 0x22d1b8, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.14"
        elif "version 4.16" == from_string( program_image, 0x2308de, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.16"
        elif "version 4.17" == from_string( program_image, 0x21cf8e, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.17"
        elif "version 4.20" == from_string( program_image, 0x23713a, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.20"
        elif "version 4.21" == from_string( program_image, 0x237524, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.21"
        elif "version 4.22" == from_string( program_image, 0x3c88b9, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.22"
        elif "version 4.23" == from_string( program_image, 0x38d3ed, 12 )[ 0 ]:
        ...
        elif "version 4.26" == from_string( program_image, 0x26b1f9, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.26"
        elif "version 4.27" == from_string( program_image, 0x278bc4, 12 )[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.27"
        elif "version 4.28" == from_string( program_image, 0x3126f9, 12)[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.28"
        elif "version 4.29" == from_string( program_image, 0x313bfb, 12)[ 0 ]:
            platform, version = PLATFORM_LINUX( ), "4.29"
        elif "version 4.30" == from_string( program_image, 0x31571a, 12)[ 0 ]:
            platform, version = PLATFORM_LINUX(), "4.30"
        else:
