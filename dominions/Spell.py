...
class Spells_DataTable( _DataTable_NamedInteger, _DataTable_ProgramImage ):
    ...
    _PROGRAM_IMAGE_BASE_OFFSETS = {
        _PLATFORM_LINUX( ): {
            ...
            "4.17": 0x0EDC4E0, "4.20": 0x0CE3EC0, "4.21": 0x0eed460, "4.22": 0x0eee4e0,
            "4.23": 0x0f71600, "4.24": 0x06d3560, "4.25": 0x0fef960, "4.26": 0x079c880,
            "4.27": 0x07b1f80, "4.28": 0x0846aa0, "4.29": 0x0848ae0, "4.30": 0x0849b40
        }
    }
    _PROGRAM_IMAGE_BASE_OFFSETS_DESCRIPTIONS_INDEX = {
        _PLATFORM_LINUX( ): {
            "4.03": 0x2D2316, "4.04": 0x348FB3, "4.05": 0x217D83,
        }
    }
    _PROGRAM_IMAGE_BASE_OFFSETS_DESCRIPTIONS = {
        _PLATFORM_LINUX( ): {
            "4.03": 0x2DF8D0, "4.04": 0x34EDE8, "4.05": 0x224610,
        }
    }
